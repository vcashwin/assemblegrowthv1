...
export default function Home() {
  return (
    <>
      ...
      <div className="relative flex min-h-full flex-col items-center overflow-hidden font-heading gap-24">
        ...
        <div className="sm:max-w-auto relative flex flex-col gap-10 px-10 pt-24 pb-24 sm:mx-auto sm:rounded-lg sm:px-20 bg-lightorange">
